"""Train a hybrid Transformer (text) + MLP (tabular) model."""
...
def train_hybrid_transformer_model(
    ...
    for epoch in range(start_epoch, max_epochs + 1):
        ...
        save_training_curves(
            ...
            history.val_losses,
            curve_path,
            title="Hybrid Transformer Training Curves",
        )
    ...
    save_comparison_chart(city=city, hybrid_transformer_r2=metrics["r2"])
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Train hybrid Transformer+tabular model for Airbnb prediction."
    )
...
if __name__ == "__main__":
    ...
    train_hybrid_transformer_model(
        city=args.city,
